...
const StudentSettings = () => {
  ...
  const handleDownloadData = () => {
    const data = {
      ...
      privacy,
      activity: [
        'Registered for AI Hackathon 2025',
        'Saved Career Workshop',
    ...
    a.href = url;
    a.download = 'my-campuschain-data.json';
    a.click();
  ...
  return (
    <DashboardLayout role="student">
      <div className="max-w-2xl mx-auto space-y-10 py-8">
        {/* Page Title */}
        <div className="mb-2">
          <h1 className="text-3xl font-bold text-indigo-700 mb-1 flex items-center gap-2"><FaUserCog className="text-indigo-500" /> Settings</h1>
        ...
        <div className="bg-gradient-to-br from-white via-indigo-50 to-purple-50 rounded-2xl shadow-lg p-8 border border-indigo-100">
          ...
          <div className="space-y-5">
            ...
            <label className="flex items-center gap-3 justify-between">
              <span>Allow direct messages from other students</span>
              <span className="inline-block">
                <button
                  type="button"
